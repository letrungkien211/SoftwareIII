...
.. code-block:: xml
  ...
  <launch>
    ...
    <node args="0 0 1.5 0 0 0 /map /camera_link 100" name="map_openni_camera" pkg="tf" type="static_transform_publisher" />
    </launch>
...
.. code-block:: xml
  ...
  <launch>
    ...
    <arg default="/camera/rgb/points" name="tabletop_segmentation_points_in" />
  
    <arg name="tabletop_segmentation_convert_to_base_link" value="true" /> 
    <aarg name="tabletop_segmentation_convert_to_base_link" value="false" />  
    <arg default="0.003" name="tabletop_segmentation_clustering_voxel_size" />
    <arg default="false" name="flatten_table" />
    <arg default="0.02" name="table_padding" />
  
  
    <node name="tabletop_segmentation" output="screen" pkg="tabletop_object_detector" respawn="true" type="tabletop_segmentation">
      ...
      <param name="processing_frame" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="" />
      <param name="up_direction" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="-1.0" />
      <param name="z_filter_min" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="0.4" />
      <param name="z_filter_max" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="1.25" />
      <param name="y_filter_min" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="-1.2" />
      <param name="y_filter_max" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="1.2" />
      <param name="x_filter_min" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="-1.2" />
      <param name="x_filter_max" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="1.2" />
      <param name="table_z_filter_min" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="0.01" />
      <param name="table_z_filter_max" unless="$(arg tabletop_segmentation_convert_to_base_link)" value="0.5" />			
