...
\title{2009年度 機械情報夏学期\\計算機演習　デバイスプログラミング
}
...
本日の演習では，カメラデバイス並びにオーディオデバイスのコントロール
%と，シリアル通信
を通じて，ソフトウェアシステムからハードウェアを制御と入出
力するための概念と方法を学習する．

ここで，理解してほしいのはカメラデバイス，オーディオデバイス
%，シリアル通信
の制御と入出力は，ファイルの読み書きと同様の制御と入出力が可能であ
るということであり，ソフトウェアシステムの観点からみると，カメラ，オー
ディオ
%，シリアルデバイス
は，ファイルとして仮想化されていることで，対象
がカメラであるかファイルであるかに関わらずファイルの入出力関数が利用で
きる．
...
... (略) ...
 \end{verbatim}
\end{commandline}
例えば，{\small\verb+soundcore+}はサウンドデバイスのデバイスドライバであり，
{\small\verb+e1000+}はネットワークカードのドライバである．
...
crw-rw----   1 root root   89,   0 2007-09-22 11:37 i2c-0
prw-------   1 root root         0 2009-05-30 01:05 initctl
drwxr-xr-x   3 root root       260 2009-05-30 01:05 input
crw-r-----   1 root kmem    1,   2 2009-05-30 01:03 kmem
crw-rw----   1 root root    1,  11 2007-09-22 06:50 kmsg
                 :
                 :
 \end{verbatim}
\end{commandline}
...
カメラもまたデバイスファイル経由でアクセスができる．カメラのデバイスファ
...
カメラデバイスの設定も，サウンドデバイス同様システムコール\verb|ioctl()|を用いて行う．
...
\begin{excersize}{課題4}
 \begin{enumerate}
  \item ２値化，エッジ抽出を行うプログラムcapture\_threshold.c capture\_edge.cを作成しMakefileも更
	新せよ．
 \end{enumerate}
\end{excersize}
...
\begin{excersize}{アドバンスド課題2}
 \begin{enumerate}
  \item これ以外のサンプルプログラムを参考に画像処理プログラムを作ってみ
	よ．オプティカルフロー，特徴点抽出，ハフ変換，テンプレートマッチ
	ング，顔検出などが主要なものであろう．他にも面白いものを見つけて
	ほしい．
 \end{enumerate}
\end{excersize}
...
\appendix
\section{サウンドデバイス ソースコード}

\subsection{Makefile\label{ssec:src:makefile}}

\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/sound/Makefile.sjis}
}
\end{multicols}

\subsection{play.c\label{ssec:src:play}}

\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/sound/play.c.sjis}
}
\end{multicols}

\newpage

\subsection{soundlib.h\label{ssec:src:soundlib.h}}

\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/sound/soundlib.h.sjis}
}
\end{multicols}

\subsection{soundlib.c\label{ssec:src:soudnlib.c}}

\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/sound/soundlib.c.sjis}
}
\end{multicols}
...
\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/camera1/Makefile.sjis}
}
\end{multicols}
...
\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/camera1/videocapture.c.sjis}
}
\end{multicols}
...
\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/camera1/videocapture.h.sjis}
}
\end{multicols}
...
\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/camera1/videocapture_mmap.c.sjis}
}
\end{multicols}
...
\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/camera1/videocapture_read.c.sjis}
}
\end{multicols}
...
\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/camera2/Makefile.sjis}
}
\end{multicols}
...
\begin{multicols}{2}
{\scriptsize
\listinginput[1]{1}{enshu-20090604/camera2/capture.c.sjis}
}
\end{multicols}
